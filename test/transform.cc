...
int main()
{
    ...
    Shader ourShader("../../resource/glsl/vertex.s", "../../resource/glsl/frame.s");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        pos_x -= 0.005;
        pos_x = (pos_x < -1.0f) ? 0.0f : pos_x;
        pos_y += 0.005;
        pos_y = (pos_y > 1.0f) ? 0.0f : pos_y;
        ...
        trans = glm::translate(trans, glm::vec3(0.5f + pos_x, -0.5f + pos_y, 0.0f));
        ...
        trans2 = glm::translate(trans2, glm::vec3(-0.5f + pos_y, 0.5f + pos_x, 0.0f));
        float scale_val = std::abs(std::sin((float)glfwGetTime()));
...
void framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
    ...
    if(window == nullptr) std::cout << std::endl;
